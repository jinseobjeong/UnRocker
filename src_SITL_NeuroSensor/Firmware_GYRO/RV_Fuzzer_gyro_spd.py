...
#        self.repeatedly_apply_parameter_file(param_fname)
    ...
    for m_count in range(MAX_COUNT):
        ...
        res3 = subprocess.Popen("/home/sysseclab/anaconda3/envs/tf3/bin/python ~/prj_jsjeong/gyro_autoencoder_1D_PX4_SITL_MA/trt_inference_p2.py",shell=True)
        time.sleep(5)
        #####
...
#                                                                        attack_freq)
            msg = 'crashed SIM_gyro ATTACK at CUTOFF 20, D 0.5, AMP: %f, FREQ: %d\n' % (attack_amp, attack_freq)
            out.write(msg)
...
#                msg = 'Crashed INS_All ATTACK at CUTOFF 5, AMP: 4.500000, FREQ: %d\n' % (attack_freq)
            msg = 'Not Crashed all SIM_gyro ATTACK at CUTOFF 20, D 0.5, AMP: 0.5, FREQ: %d\n' % (attack_freq)
