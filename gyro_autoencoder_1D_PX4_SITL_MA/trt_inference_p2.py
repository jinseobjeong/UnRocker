                ...
                if recv_count < LENGTH:
                    ...
                    if v_inf_first.value == 0:
                        ...
                        if v_end.value == 1:# and v_copy.value == 0:
                            ...
                            v_end.value = 0
                            time_log = 1
                        #recovered = (result_data[LENGTH-1]+result_data[LENGTH-2]+result_data[LENGTH-3])/3#+temp_count2-7]
                        recovered = result_data[LENGTH+temp_count2-7]##    recovered = a_input[LENGTH-5]#raw_signal#test data
